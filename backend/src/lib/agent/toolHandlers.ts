...
export async function toolSearchCgFields(input: { query: string; conversationId: string }) {
	return handleSearchCgFields(input);
}

export async function toolSearchLocation(input: { query: string; conversationId: string }) {
	return handleSearchLocation(input);
}

export async function toolSearchTransaction(input: { query: string; conversationId: string }) {
...
export async function toolRemoveSignal(input: { conversationId: string; signalId: string }) {
...
export async function toolEstimateAudience(input: { conversationId: string }) {
	const conversation = await prisma.conversation.findUnique({
		where: { id: input.conversationId },
	});
