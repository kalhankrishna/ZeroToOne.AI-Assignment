...
import type { Message, Signal, AudienceEstimate, ConversationDetail } from '../lib/types';
			...
			<div className="signals-panel">
				...
				<div className="signal-actions">
					{status === 'BUILDING' && signals.length > 0 && (
						<button className="action-btn" onClick={handleConfirm} disabled={sending}>
							<CheckCircle size={16} />
							Confirm Signals
						</button>
					)}
					...
					{status === 'CONFIRMED' && (
						<button className="action-btn" onClick={handleEstimate} disabled={sending}>
							<BarChart3 size={16} />
							Estimate Audience
						</button>
					)}
